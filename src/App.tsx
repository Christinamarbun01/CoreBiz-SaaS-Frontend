...
const DEMO_ORDER: KanbanOrder = {
  ...
  // ← Object bebas dari hasil Blind Parser WA — key tidak di-hardcode
  custom_data: {
...
function App() {
  ...
  // ── Guard: shift diperlukan untuk POS ──
  const needsShift = activeTab === 'pos' && !activeShift;

  // ── Loading screen while checking shift ──
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent side="right" align="end" className="w-56">
              <DropdownMenuLabel className="font-normal">
                ...
                <p className="text-xs text-slate-400">Staff • Dev Mode</p>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />

              {activeShift ? (
                <>
                  {/* Shift aktif — tampilkan menu tutup */}
                ...
                <>
                  {/* Tidak ada shift — tampilkan menu buka */}
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() => setActiveTab('pos')} // redirect to POS which shows blocker
                  >
                    <Unlock size={14} />
                    Buka Kasir
                  </DropdownMenuItem>
